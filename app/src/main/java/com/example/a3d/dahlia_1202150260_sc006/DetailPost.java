package com.example.a3d.dahlia_1202150260_sc006;
...
import com.example.a3d.dahlia_1202150260_sc006.adapter.AdapterComment;
import com.example.a3d.dahlia_1202150260_sc006.model.User;
        ...
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener () {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!TextUtils.isEmpty(textReview)) {
                    ...
                    Comment track = new Comment (id, user.getUsername (), textReview, (-timestamp));
